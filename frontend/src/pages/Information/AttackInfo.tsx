...
const columns: GridColDef[] = [
  ...
  },
  {
    ...
    renderCell(params) {
        ...
        if(value === '0' || value === '' || (row.effect_naam !== 'Sleep' && row.effect_naam !== 'Poisoned' && row.effect_naam !== 'Flinch' && row.effect_naam !== 'Burn' && row.effect_naam !== 'Freeze' && row.effect_naam !== 'Confued')) {
            return ' -- ';
        }
