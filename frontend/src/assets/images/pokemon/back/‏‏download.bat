...
set /p startNum=Enter the starting number (e.g. 800): 
set /p endNum=Enter the ending number (e.g. 809): 
...
for /l %%i in (%startNum%,1,%endNum%) do (
    set "url=https://www.pokemon-arena.kyokai.hu/images/pokemon/back/%%i.gif"
    set "fileName=%%i.gif"
